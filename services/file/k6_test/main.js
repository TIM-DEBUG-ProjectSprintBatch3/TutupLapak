...
const smallFile = open('./figures/image-50KB.jpg', 'b');
const medFile = open('./figures/image-90KB.jpg', 'b');
const bigFile = open('./figures/image-100KB.jpg', 'b');
const hugeFile = open('./figures/image-200KB.jpg', 'b');
const invalidFile = open('./figures/sql-5KB.sql', 'b');
